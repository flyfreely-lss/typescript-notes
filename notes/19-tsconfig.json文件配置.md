...
// 我的速查表
{
    ...
    "files": [], // 指定文件的相对或绝对路径，用来指定待编译文件,只能指定文件
    "include": [], // 既可以指定文件，又可以指定目录
    "exclude": [], // 默认值为 node_modules 、bower_components、jspm_packages 和编译选项 outDir 指定的路径
    "compileOnSave": false, //这个特性需要Visual Studio 2015， TypeScript1.8.4以上并且安装atom-typescript插件。
    "extends": "", // 实现配置复用
    "compilerOptions": {
      "target": "es5",
      "module": "commonjs",                      
      ...
      "importHelpers": true,  // 搭配 tslib 使用                 
      "lib": ["es6", "dom"],                  
      "typeRoots": ["node_modules/@types"],
      "outDir": "./dist",
      "rootDir": "./src",
      "preserveConstEnums": true,  // 是否保留常量枚举对象
      "strictNullChecks": false,  // 函数兼容，非空检查
      "strictPropertyInitialization": true, // 保证变量声明和实例属性都会有初始值
      "declaration": true, // 是否自动生成 .d.ts 文件
    }
  }
